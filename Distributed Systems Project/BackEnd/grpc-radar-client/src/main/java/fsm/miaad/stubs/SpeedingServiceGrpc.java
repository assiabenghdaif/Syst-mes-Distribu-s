...
public final class SpeedingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Request,
      fsm.miaad.stubs.Radargrpc.Response> getSpeedingRandomlyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SpeedingRandomly",
      requestType = fsm.miaad.stubs.Radargrpc.Request.class,
      responseType = fsm.miaad.stubs.Radargrpc.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Request,
      fsm.miaad.stubs.Radargrpc.Response> getSpeedingRandomlyMethod() {
    io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Request, fsm.miaad.stubs.Radargrpc.Response> getSpeedingRandomlyMethod;
      ...
      synchronized (SpeedingServiceGrpc.class) {
        if ((getSpeedingRandomlyMethod = SpeedingServiceGrpc.getSpeedingRandomlyMethod) == null) {
          SpeedingServiceGrpc.getSpeedingRandomlyMethod = getSpeedingRandomlyMethod = 
              io.grpc.MethodDescriptor.<fsm.miaad.stubs.Radargrpc.Request, fsm.miaad.stubs.Radargrpc.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "SpeedingService", "SpeedingRandomly"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fsm.miaad.stubs.Radargrpc.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fsm.miaad.stubs.Radargrpc.Response.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Empty,
      fsm.miaad.stubs.Radargrpc.Radars> getGetRadarIDExistMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetRadarIDExist",
      requestType = fsm.miaad.stubs.Radargrpc.Empty.class,
      responseType = fsm.miaad.stubs.Radargrpc.Radars.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Empty,
      fsm.miaad.stubs.Radargrpc.Radars> getGetRadarIDExistMethod() {
    io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Empty, fsm.miaad.stubs.Radargrpc.Radars> getGetRadarIDExistMethod;
      ...
      synchronized (SpeedingServiceGrpc.class) {
        if ((getGetRadarIDExistMethod = SpeedingServiceGrpc.getGetRadarIDExistMethod) == null) {
          SpeedingServiceGrpc.getGetRadarIDExistMethod = getGetRadarIDExistMethod = 
              io.grpc.MethodDescriptor.<fsm.miaad.stubs.Radargrpc.Empty, fsm.miaad.stubs.Radargrpc.Radars>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "SpeedingService", "GetRadarIDExist"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fsm.miaad.stubs.Radargrpc.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fsm.miaad.stubs.Radargrpc.Radars.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Empty,
      fsm.miaad.stubs.Radargrpc.Vehicles> getGetVehicleIDExistMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetVehicleIDExist",
      requestType = fsm.miaad.stubs.Radargrpc.Empty.class,
      responseType = fsm.miaad.stubs.Radargrpc.Vehicles.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Empty,
      fsm.miaad.stubs.Radargrpc.Vehicles> getGetVehicleIDExistMethod() {
    io.grpc.MethodDescriptor<fsm.miaad.stubs.Radargrpc.Empty, fsm.miaad.stubs.Radargrpc.Vehicles> getGetVehicleIDExistMethod;
      ...
      synchronized (SpeedingServiceGrpc.class) {
        if ((getGetVehicleIDExistMethod = SpeedingServiceGrpc.getGetVehicleIDExistMethod) == null) {
          SpeedingServiceGrpc.getGetVehicleIDExistMethod = getGetVehicleIDExistMethod = 
              io.grpc.MethodDescriptor.<fsm.miaad.stubs.Radargrpc.Empty, fsm.miaad.stubs.Radargrpc.Vehicles>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fsm.miaad.stubs.Radargrpc.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fsm.miaad.stubs.Radargrpc.Vehicles.getDefaultInstance()))
  ...
  public static abstract class SpeedingServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<fsm.miaad.stubs.Radargrpc.Request> speedingRandomly(
        io.grpc.stub.StreamObserver<fsm.miaad.stubs.Radargrpc.Response> responseObserver) {
      return asyncUnimplementedStreamingCall(getSpeedingRandomlyMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<fsm.miaad.stubs.Radargrpc.Empty> getRadarIDExist(
        io.grpc.stub.StreamObserver<fsm.miaad.stubs.Radargrpc.Radars> responseObserver) {
      return asyncUnimplementedStreamingCall(getGetRadarIDExistMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<fsm.miaad.stubs.Radargrpc.Empty> getVehicleIDExist(
        io.grpc.stub.StreamObserver<fsm.miaad.stubs.Radargrpc.Vehicles> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                fsm.miaad.stubs.Radargrpc.Request,
                fsm.miaad.stubs.Radargrpc.Response>(
                  this, METHODID_SPEEDING_RANDOMLY)))
          .addMethod(
            getGetRadarIDExistMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                fsm.miaad.stubs.Radargrpc.Empty,
                fsm.miaad.stubs.Radargrpc.Radars>(
          ...
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                fsm.miaad.stubs.Radargrpc.Empty,
                fsm.miaad.stubs.Radargrpc.Vehicles>(
  ...
  private static abstract class SpeedingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return fsm.miaad.stubs.Radargrpc.getDescriptor();
    }
